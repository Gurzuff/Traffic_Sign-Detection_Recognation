if __name__ == '__main__':
    ...
    class_map_root = '../../Training_model/src/class_mapping.json'
    with open(class_map_root, 'r') as file:
        class_mapping = json.load(file)
    inv_class_mapping = {v: k for k, v in class_mapping.items()}

    # Load model
    model_root = '../../Training_model/src/trained_models_tf'
    ...
    root_unknown_signs = '../../1. segmentation_image/src/segmented_sign'
