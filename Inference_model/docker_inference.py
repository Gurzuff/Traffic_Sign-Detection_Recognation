...
def final_image(PATH_labels: str,
    ...
    Saves the resulting composite image in the 'inference_docker' directory.
    '''
    ...
    low_quality_img = Image.open('data/Low_quality.png')
...
model.load_weights(f'weights/{name_weight}.hdf5')

# Paths to sign labels, segmented test images and segmented road signs
PATH_sign_labels = 'data/class_labels'
...
df_classes = pd.read_csv('data/sign_names.csv')
